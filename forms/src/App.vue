    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                ...
                <transition enter-active-class="animated bounce infinite" leave-active-class="animated shake">
                    <div class="alert alert-info" v-if="show">This is some Info</div>
                </transition>
...
<script>
    import DangerAlert from "./componentsAnimation/DangerAlert.vue";
    import SuccesAlert from "./componentsAnimation/SuccesAlert.vue";
